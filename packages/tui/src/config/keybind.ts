...
export const Definitions = {
  ...
  session_background_jobs: keybind("none", "Show running background jobs"),
  ...
  display_thinking: keybind("none", "Cycle thinking visibility (show/hide/minimal)"),
...
export const CommandMap = {
  ...
  session_background_jobs: "session.background.jobs",
